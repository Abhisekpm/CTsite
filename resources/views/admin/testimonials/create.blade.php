                            ...
                            <form action="{{ route('testimonials/store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="settings-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" onload="convertToSlug(this.value)"
                                        onkeyup="convertToSlug(this.value)" placeholder="Enter Name Here">
                                    </div>
                                    {{-- <div class="form-group">
                                        <label>Profession <span class="star-red">*</span></label>
                                        <input type="text" class="form-control" name="position" id="position" placeholder="Enter Position Here">
                                    </div> --}}
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" name="quote" id="quote"></textarea>
                                    </div>
