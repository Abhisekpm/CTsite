                            ...
                            <form action="{{ route('category/update') }}" method="POST">
                                ...
                                <div class="settings-form">
                                    <div class="form-group">
                                        ...
                                        onkeyup="convertToSlug(this.value)" value="{{$category->title}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" name="description" id="description">{{$category->description}}</textarea>
                                    </div>
