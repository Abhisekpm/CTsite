                            ...
                            <form action="{{ route('blog/store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="settings-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Title Here" name="title" id="title" onload="convertToSlug(this.value)"
                                    ...
                                    <div class="form-group">
                                        <label>Tags</label>
                                        <input type="text" class="form-control" name="tags" placeholder="Enter Tags Here">
                                    </div>
                                </div>
                                <div class="card-header">
